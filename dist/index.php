...
<body>
    ...
    <section class="page-section relative overflow-hidden bg-white pb-14 pe-0 pt-[42px] font-mona-sans">
        <div class="thm-container">
            ...
            <div class="swiper business-card flex max-w-full flex-row items-start justify-start gap-[24px] overflow-x-auto font-mona-sans text-9xl text-black">
                <div class="swiper-wrapper">
                    <div class="swiper-slide h-full w-full max-w-[483px] shrink-0 rounded-xl border-[1px] border-solid border-gainsboro p-[30px]">
                        ...
                        <h3 class="mb-4 mt-0 text-inherit font-medium">Engineering</h3>
                    ...
                    <div class="swiper-slide h-full w-full max-w-[483px] shrink-0 rounded-xl border-[1px] border-solid border-gainsboro p-[30px] mq450:box-border mq450:pb-5 mq450:pt-5">
    ...
    <section class="page-section case-study-section flex w-full gap-[48px] overflow-hidden bg-black font-mona-sans text-21xl text-white mq700:box-border mq700:gap-[24px]">
        <div class="thm-container">
            <h2>Case studies</h2>
            <div class="max-lg:grid-cols-1 grid gap-[32.2px] gap-y-[48px] self-stretch text-left text-xl mq700:gap-[16px] mq700:gap-y-[16px] lg:grid-cols-2">
                <div class="case-study-box relative overflow-hidden rounded-[8.37px] bg-[url('../images/case-studies/lsu.jpg')] bg-cover bg-[top] bg-no-repeat mq950:min-w-full">
                    ...
                    <div class="absolute bottom-0 z-[1] box-border flex w-full max-w-full flex-1 shrink-0 flex-col items-start justify-end gap-[16.7px] overflow-hidden pb-[27.7px] pe-8 ps-8 [background:linear-gradient(-0.46deg,_#000,_rgba(102,_102,_102,_0))] mq1325:pe-3 mq1325:ps-3 mq700:box-border">
                        <img class="relative z-[2] h-[23px] object-contain" loading="lazy" alt="" src="assets/images/case-studies/lsu-logo.svg" />
                        <p class="z-[2] m-0 inline-block w-[40rem] max-w-full font-medium leading-[28px] mq450:text-base mq450:leading-[22px]">
                        ...
                        <div class="footer-wrap">
                            ...
                            <div class="flex gap-3">
                                <button class="view-testimonial">
                                    <img src="assets/images/case-studies/play-icon.svg" />
                                    View Testimonial
                                </button>
                                <button class="btn-right">
                                    <img src="assets/images/case-studies/right-arrow.svg" />
                                </button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="case-study-box relative flex max-w-full flex-1 flex-row items-start justify-start overflow-hidden rounded-[8.37px] bg-[url('../images/case-studies/stc-pay.jpg')] bg-cover bg-[top] bg-no-repeat mq950:min-w-full">
                    <div class="apect-ratio-thumb">
                ...
                <div class="case-study-box relative flex max-w-full flex-1 flex-row items-start justify-start overflow-hidden rounded-[8.37px] bg-[url('../images/case-studies/family-dollar.jpg')] bg-cover bg-[top] bg-no-repeat mq950:min-w-full">
                    <div class="apect-ratio-thumb">
                ...
                <div class="case-study-box relative flex max-w-full flex-1 flex-row items-start justify-start overflow-hidden rounded-[8.37px] bg-[url('../images/case-studies/caribbean-airlines.jpg')] bg-cover bg-[top] bg-no-repeat mq950:min-w-full">
                    <div class="apect-ratio-thumb">
    ...
    <section class="page-section overflow-hidden font-mona-sans text-21xl text-black">
        <div class="thm-container">
            ...
            <div class="swiper client-wrapper rounded-3xl border-[1px] border-solid border-gainsboro bg-whitesmoke p-4 font-mona-sans text-13xl text-black md:p-[4.375rem]">
                <div class="swiper-wrapper">
                    <div class="swiper-slide !flex flex-col-reverse items-start justify-between gap-[20px] pe-1 ps-0 lg:flex-row">
                        <div class="flex w-full max-w-[808px] flex-col">
    ...
    <section class="w-full overflow-hidden bg-gray-300 pb-[80px] pt-[80px] md:pb-[197px] md:pt-[198px]">
        <div class="thm-container">
            <div class="box-border flex flex-col items-start justify-between gap-[40px] font-mona-sans text-53xl text-lightslategray mq1200:flex-row mq1200:gap-[100px] 2xl:box-border">
                <div class="self-stretch mq1200:max-w-[50.438rem]">
                    <h3 class="mb-8 mt-0 !bg-clip-text font-semibold leading-[76px] tracking-[-2.2px] text-transparent [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] [background:linear-gradient(91.61deg,_#b5ffec,_#fff)] mq900:text-39xl mq900:leading-[61px] mq450:mb-[16px] mq450:text-24xl mq450:leading-[46px]">
                ...
                <div class="min-[900px]:max-w-[738px] flex w-full flex-row items-start justify-start text-white mq900:flex-col mq900:gap-[74px] min900:gap-[100px]">
                    <div class="flex min-w-[250px] flex-1 flex-col items-start justify-start gap-[74px] mq900:w-full mq450:gap-[37px]">
                    ...
                    <div class="flex min-w-[250px] flex-1 flex-col items-start justify-start gap-[50px] mq1325:gap-[74px] mq1025:gap-[50px] mq900:w-full mq450:gap-[37px]">
                        <div class="flex flex-col items-start justify-start gap-[19.5px] self-stretch">
                            <div class="relative box-border h-px self-stretch border-t-[1px] border-solid border-mediumaquamarine"></div>
                            <div class="mt-[6px] flex flex-row items-start justify-between gap-[20px] self-stretch">
                                <h4 class="my-0 font-medium leading-[57px] tracking-[-4.14px] mq900:text-39xl mq900:leading-[55px] mq450:text-24xl mq450:leading-[41px]">
    ...
    <section class="page-section w-full gap-[48px] overflow-hidden bg-white pb-[53.2px] pe-0 pt-14 font-mona-sans text-21xl text-black mq975:box-border mq700:box-border mq700:gap-[24px]">
        <div class="thm-container">
            ...
            <div class="swiper business-card insight-card">
                <div class="swiper-wrapper text-smi text-white">
                    <div class="swiper-slide box-border flex max-w-[400px] shrink-0 flex-col items-start justify-start gap-[18.9px] pb-[0.5px]">
    ...
    <section class="page-section flex w-full flex-col items-center justify-start bg-generic-white">
        <div class="thm-container">
            ...
            <div class="swiper logo-wrapper box-border max-w-full self-stretch overflow-auto rounded-xl border-[1px] border-solid border-lightgray pb-[1.625rem] pe-[3.375rem] ps-[3.312rem] pt-[1.562rem] [background:linear-gradient(90deg,_#fff,_rgba(239,_239,_239,_0)_50.5%,_#fff)] mq825:gap-[2rem] mq450:gap-[1rem] 2xl:box-border 2xl:pe-[1.688rem] 2xl:ps-[1.625rem]">
                <div class="swiper-wrapper flex flex-row items-center justify-center gap-[.7rem]">
                    <img class="swiper-slide max-w-full px-[0.937rem] pb-[2rem] pt-[2rem]" loading="lazy" alt="" src="assets/images/awards/clutch-web-developers.png" />
                    <img class="swiper-slide max-w-full px-[0.937rem] pb-[2rem] pt-[2rem]" loading="lazy" alt="" src="assets/images/awards/superbcompanies.png" />
                    <img class="swiper-slide px-[0.937rem] pb-[2rem] pt-[2rem]" loading="lazy" alt="" src="assets/images/awards/clutch-modernization-service.png" />
                    <img class="swiper-slide max-w-full px-[0.937rem] pb-[2rem] pt-[2rem]" loading="lazy" alt="" src="assets/images/awards/business-firms.png" />
                    <img class="swiper-slide px-[0.937rem] pb-[0.262rem] pb-[2rem] pt-[2rem]" loading="lazy" alt="" src="assets/images/awards/clutch-artificial-intelligence-company.png" />
                    <img class="swiper-slide px-[0.937rem] pb-[2rem] pt-[2rem]" loading="lazy" alt="" src="assets/images/awards/featured-on-upcity.png" />

                    <img class="swiper-slide px-[0.937rem] pb-[2rem] pt-[2rem]" loading="lazy" alt="" src="assets/images/awards/clutch-iot-company.png" />
                    <img class="swiper-slide px-[0.937rem] pb-[2rem] pt-[2rem]" alt="" src="assets/images/awards/techroviewer.png" />

                    <img class="swiper-slide px-[0.937rem] pb-[2rem] pt-[2rem]" loading="lazy" alt="" src="assets/images/awards/clutch-machine-learning-company.png" />

                    <img class="swiper-slide px-[0.937rem] pb-[2rem] pt-[2rem]" loading="lazy" alt="" src="assets/images/awards/appfutura.png" />
    ...
    <!-- Section CTA Start -->
    <section class="bg-black py-[7rem] font-mona-sans text-[1.5rem] text-generic-white">
        <div class="thm-container">
            <div class="flex flex-col justify-between gap-5 lg:flex-row">
                <div class="flex w-full flex-col items-start justify-start lg:max-w-[33%]">
                ...
                <div class="flex w-full flex-col items-start justify-start gap-[3rem] font-mona-sans text-[4.5rem] lg:max-w-[45%]">
                        ...
                        <div class="flex max-w-full flex-row items-start justify-start gap-[2rem] mq900:flex-wrap mq900:gap-[1rem]">
                            ...
                            <div class="flex w-[12rem] flex-col items-start justify-start gap-[0.581rem]">
                                ...
                                <div class="flex flex-col items-start justify-start gap-[0.5rem] self-stretch px-[0rem] py-[0rem] text-[1.125rem] text-gray-1000">
                                    ...
                                    <p class="sm:w-[18.581rem] m-0 font-medium leading-[2rem]">
                                        +1 (703) 782-3019
                                    </p>
                                </div>
                            </div>
